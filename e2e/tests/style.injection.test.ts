...
test.describe
  .skip('Style Injection Quality', () => {
    ...
    test.skip('should inject casual style into responses', async ({ page, port }) => {
    ...
    test.skip('should inject technical style into responses', async ({ page, port }) => {
      test.setTimeout(60000)
    ...
    test.skip('should inject professional style into responses', async ({ page, port }) => {
      test.setTimeout(60000)
    ...
    test.skip('should inject minimal style into responses', async ({ page, port }) => {
      test.setTimeout(60000)
...
test.describe
  .skip('Style Injection via Proxy API', () => {
    ...
    test.skip('should inject style via proxy API endpoint', async ({ page, port }) => {
      test.setTimeout(60000)
    ...
    test.skip('should handle requests without style profile', async ({ page, port }) => {
      test.setTimeout(60000)
...
test.describe
  .skip('Style Comparison', () => {
    ...
    test.skip('should produce different responses for different styles', async ({ page, port }) => {
...
test.describe
  .skip('Style Injection Edge Cases', () => {
    ...
    test.skip('should handle very long user messages with style injection', async ({
      page,
      port,
    }) => {
    ...
    test.skip('should handle rapid consecutive messages with style', async ({ page, port }) => {
      test.setTimeout(90000)
