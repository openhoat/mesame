...
2. Navigate to worktree: `cd ../mesame-<name>`
...
**Steps**:
1. On main worktree: `git worktree remove ../mesame-<name>`
2. If forced removal needed: `git worktree remove --force ../mesame-<name>`
...
| Remove worktree | `git worktree remove ../mesame-<name>` |
| Force remove worktree | `git worktree remove --force ../mesame-<name>` |
...
# Create new worktree
git worktree add ../mesame-<name> <correct-branch>
```
